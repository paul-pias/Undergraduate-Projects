    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url('user/addFlatRoom');?>">Add Flat/Room</a>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo base_url('user/userProfile'); ?>"><span class="glyphicon glyphicon-user"><?php echo $username; ?></span></a></li>
